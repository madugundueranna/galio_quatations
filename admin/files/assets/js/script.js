...
$('#styleSelector').append('' +
    '<div class="selector-toggle">' +
        '<a href="javascript:void(0)" class=""><span class="m-ring"></span></a>' +
    '</div>' +
    '<ul>' +
        '<li>' +
                        ...
                        '<div class="form-radio" id="menu-effect">' +
                            '<div class="radio radio-primary radio-inline" data-toggle="tooltip" title="Color icon">' +
                                '<label>' +
                                    ...
                                    '<i class="helper"></i><span class="micon st1"><i class="fas fa-chess-queen"></i></span>' +
                                '</label>' +
                            '</div>' +
                            '<div class="radio radio-inverse radio-inline" data-toggle="tooltip" title="simple icon">' +
                                '<label>' +
                                    ...
                                    '<i class="helper"></i><span class="micon st2"><i class="fas fa-chess-queen"></i></span>' +
                                '</label>' +
                            '</div>' +
                        '</div>' +
                    '</li>' +
    ...
    '<ul>' +
        '<li>' +
            '<a href="http://html.phoenixcoded.net/dash-able/bootstrap/default/builder.php" class="btn btn-danger btn-block m-t-10 waves-effect waves-light">Live Page Builder</a>' +
            '<div class="row">' +
                '<div class="col-6">' +
                ...
                '</div>' +
                '<div class="col-6">' +
                    '<a href="http://docs.phoenixcoded.net/dash-able/bootstrap" target="_blank" class="btn btn-primary btn-block m-t-10 m-b-10 waves-effect waves-light">Documentation</a>' +
                '</div>' +
            '</div>' +
        '</li>' +
        '<li class="text-center">' +
            '<a href="https://www.facebook.com/Phoenixcoded/" target="_blank" class="btn btn-facebook soc-icon m-b-10 waves-effect waves-light"><i class="fab fa-facebook-f"></i></a>' +
            '<a href="https://twitter.com/phoenixcoded" target="_blank" class="btn btn-twitter soc-icon m-l-20 m-b-10 waves-effect waves-light"><i class="fab fa-twitter"></i></a>' +
        '</li>' +
    '</ul>' +
    '');
